...
function draw(){
    ...
    score=document.getElementById("Score"),check_sketch;
    function draw(){
...
console.error(error)
    ...
    console.log(results);
    document.getElementById('Score').innerHTML = 'Score: ' + results[0].label;


    document.getElementById('Timer').innerHTML = 'Timer: ' + Math.round(results[0].confidence*100)+'%';
